  ...
  if (newdata == true){
    ...
    if (count == 2) {
      ...
      if (jumlahnode[0] == 1 && jumlahnode[1] == 4) {
        ...
        int TofY = NodeID_4["TofY"];
        int TofZ = NodeID_4["TofZ"];
        uint32_t dUnixtime = NodeID_4["Unixtime"];
        JsonArray jsonarray = doc.to<JsonArray>();
        JsonObject jsonobject = jsonarray.createNestedObject();
        jsonobject["NodeID"] = bNodeID_1;
        jsonobject["Suhu"] = Suhu;
      ...
      if (jumlahnode[0] == 1 && jumlahnode[1] == 5) {
        ...
        int usY = NodeID_5["usY"];
        int usZ = NodeID_5["usZ"];
        uint32_t dUnixtime = NodeID_5["Unixtime"];
        JsonArray jsonarray = doc.to<JsonArray>();
        JsonObject jsonobject = jsonarray.createNestedObject();
        jsonobject["NodeID"] = bNodeID_1;
        jsonobject["Suhu"] = Suhu;
      ...
      if (jumlahnode[0] == 5 && jumlahnode[1] == 4) {
        ...
        int TofY = NodeID_4["TofY"];
        int TofZ = NodeID_4["TofZ"];
        uint32_t jUnixtime = NodeID_4["Unixtime"];
        JsonArray jsonarray = doc.to<JsonArray>();
        JsonObject jsonobject = jsonarray.createNestedObject();
        jsonobject["NodeID"] = cNodeID_5;
        jsonobject["usX"] = usX;
    ...
    if(count == 4){
      ...
      if(jumlahnode[0] == 5 && jumlahnode[1] == 4 && jumlahnode[2] == 2 && jumlahnode[3] == 1){
        JsonObject NodeID_5 = doc[0];
        int fNodeID_5 = NodeID_5["NodeID"];
        int usX = NodeID_5["usX"];
        int usY = NodeID_5["usY"];
        ...
        jsonobject4["Pitch"] = Pitch;
        jsonobject4["Roll"] = Roll;
        jsonobject4["Frekuensi"] = Frekuensi;
      ...
      if(jumlahnode[0] == 5 && jumlahnode[1] == 4 && jumlahnode[2] == 1 && jumlahnode[3] == 2){
        JsonObject NodeID_5 = doc[0];
        int fNodeID_5 = NodeID_5["NodeID"];
        int usX = NodeID_5["usX"];
        int usY = NodeID_5["usY"];
      ...
      if(jumlahnode[0] == 5 && jumlahnode[1] == 2 && jumlahnode[2] == 4 && jumlahnode[3] == 1){
        JsonObject NodeID_5 = doc[0];
        int fNodeID_5 = NodeID_5["NodeID"];
        int usX = NodeID_5["usX"];
        int usY = NodeID_5["usY"];
      ...
      if(jumlahnode[0] == 5 && jumlahnode[1] == 2 && jumlahnode[2] == 1 && jumlahnode[3] == 4){
        JsonObject NodeID_5 = doc[0];
        int fNodeID_5 = NodeID_5["NodeID"];
        int usX = NodeID_5["usX"];
        int usY = NodeID_5["usY"];
      ...
      if(jumlahnode[0] == 5 && jumlahnode[1] == 1 && jumlahnode[2] == 4 && jumlahnode[3] == 2){
        JsonObject NodeID_5 = doc[0];
        int fNodeID_5 = NodeID_5["NodeID"];
        int usX = NodeID_5["usX"];
        int usY = NodeID_5["usY"];
      ...
      if(jumlahnode[0] == 5 && jumlahnode[1] == 1 && jumlahnode[2] == 2 && jumlahnode[3] == 4){
        JsonObject NodeID_5 = doc[0];
        int fNodeID_5 = NodeID_5["NodeID"];
        int usX = NodeID_5["usX"];
        int usY = NodeID_5["usY"];
      ...
      if(jumlahnode[0] == 4 && jumlahnode[1] == 5 && jumlahnode[2] == 2 && jumlahnode[3] == 1){
        JsonObject NodeID_4 = doc[0];
        int fNodeID_4 = NodeID_4["NodeID"];
        int TofX = NodeID_4["TofX"];
        int TofY = NodeID_4["TofY"];
      ...
      if(jumlahnode[0] == 4 && jumlahnode[1] == 5 && jumlahnode[2] == 1 && jumlahnode[3] == 2){
        JsonObject NodeID_4 = doc[0];
        int fNodeID_4 = NodeID_4["NodeID"];
        int TofX = NodeID_4["TofX"];
        int TofY = NodeID_4["TofY"];
      ...
      if(jumlahnode[0] == 4 && jumlahnode[1] == 2 && jumlahnode[2] == 5 && jumlahnode[3] == 1){
        JsonObject NodeID_4 = doc[0];
        int fNodeID_4 = NodeID_4["NodeID"];
        int TofX = NodeID_4["TofX"];
        int TofY = NodeID_4["TofY"];
      ...
      if(jumlahnode[0] == 4 && jumlahnode[1] == 2 && jumlahnode[2] == 1 && jumlahnode[3] == 5){
        JsonObject NodeID_4 = doc[0];
        int fNodeID_4 = NodeID_4["NodeID"];
        int TofX = NodeID_4["TofX"];
        int TofY = NodeID_4["TofY"];
      ...
      if(jumlahnode[0] == 4 && jumlahnode[1] == 1 && jumlahnode[2] == 5 && jumlahnode[3] == 2){
        JsonObject NodeID_4 = doc[0];
        int fNodeID_4 = NodeID_4["NodeID"];
        int TofX = NodeID_4["TofX"];
        int TofY = NodeID_4["TofY"];
      ...
      if(jumlahnode[0] == 4 && jumlahnode[1] == 1 && jumlahnode[2] == 2 && jumlahnode[3] == 5){
        JsonObject NodeID_4 = doc[0];
        int fNodeID_4 = NodeID_4["NodeID"];
        int TofX = NodeID_4["TofX"];
        int TofY = NodeID_4["TofY"];
      ...
      if(jumlahnode[0] == 2 && jumlahnode[1] == 5 && jumlahnode[2] == 4 && jumlahnode[3] == 1){
        JsonObject NodeID_2 = doc[0];
        int fNodeID_2 = NodeID_2["NodeID"];
        int Berat = NodeID_2["Berat"];
        uint32_t pUnixtime = NodeID_2["Unixtime"];
      ...
      if(jumlahnode[0] == 2 && jumlahnode[1] == 5 && jumlahnode[2] == 1 && jumlahnode[3] == 4){
        JsonObject NodeID_2 = doc[0];
        int fNodeID_2 = NodeID_2["NodeID"];
        int Berat = NodeID_2["Berat"];
        uint32_t pUnixtime = NodeID_2["Unixtime"];
      ...
      if(jumlahnode[0] == 2 && jumlahnode[1] == 4 && jumlahnode[2] == 5 && jumlahnode[3] == 1){
        JsonObject NodeID_2 = doc[0];
        int fNodeID_2 = NodeID_2["NodeID"];
        int Berat = NodeID_2["Berat"];
        uint32_t pUnixtime = NodeID_2["Unixtime"];
      ...
      if(jumlahnode[0] == 2 && jumlahnode[1] == 4 && jumlahnode[2] == 1 && jumlahnode[3] == 5){
        JsonObject NodeID_2 = doc[0];
        int fNodeID_2 = NodeID_2["NodeID"];
        int Berat = NodeID_2["Berat"];
        uint32_t pUnixtime = NodeID_2["Unixtime"];
      ...
      if(jumlahnode[0] == 2 && jumlahnode[1] == 1 && jumlahnode[2] == 5 && jumlahnode[3] == 4){
        JsonObject NodeID_2 = doc[0];
        int fNodeID_2 = NodeID_2["NodeID"];
        int Berat = NodeID_2["Berat"];
        uint32_t pUnixtime = NodeID_2["Unixtime"];
      ...
      if(jumlahnode[0] == 2 && jumlahnode[1] == 1 && jumlahnode[2] == 4 && jumlahnode[3] == 5){
        JsonObject NodeID_2 = doc[0];
        int fNodeID_2 = NodeID_2["NodeID"];
        int Berat = NodeID_2["Berat"];
        uint32_t pUnixtime = NodeID_2["Unixtime"];
      ...
      if(jumlahnode[0] == 1 && jumlahnode[1] == 5 && jumlahnode[2] == 4 && jumlahnode[3] == 2){
        JsonObject NodeID_1 = doc[0];
        int fNodeID_1 = NodeID_1["NodeID"];
        int Suhu = NodeID_1["Suhu"];
        int Kelembapan = NodeID_1["Kelembapan"];
      ...
      if(jumlahnode[0] == 1 && jumlahnode[1] == 5 && jumlahnode[2] == 2 && jumlahnode[3] == 4){
        JsonObject NodeID_1 = doc[0];
        int fNodeID_1 = NodeID_1["NodeID"];
        int Suhu = NodeID_1["Suhu"];
        int Kelembapan = NodeID_1["Kelembapan"];
      ...
      if(jumlahnode[0] == 1 && jumlahnode[1] == 4 && jumlahnode[2] == 5 && jumlahnode[3] == 2){
        JsonObject NodeID_1 = doc[0];
        int fNodeID_1 = NodeID_1["NodeID"];
        int Suhu = NodeID_1["Suhu"];
        int Kelembapan = NodeID_1["Kelembapan"];
      ...
      if(jumlahnode[0] == 1 && jumlahnode[1] == 4 && jumlahnode[2] == 2 && jumlahnode[3] == 5){
        JsonObject NodeID_1 = doc[0];
        int fNodeID_1 = NodeID_1["NodeID"];
        int Suhu = NodeID_1["Suhu"];
        int Kelembapan = NodeID_1["Kelembapan"];
      ...
      if(jumlahnode[0] == 1 && jumlahnode[1] == 2 && jumlahnode[2] == 5 && jumlahnode[3] == 4){
        JsonObject NodeID_1 = doc[0];
        int fNodeID_1 = NodeID_1["NodeID"];
        int Suhu = NodeID_1["Suhu"];
        int Kelembapan = NodeID_1["Kelembapan"];
      ...
      if(jumlahnode[0] == 1 && jumlahnode[1] == 2 && jumlahnode[2] == 4 && jumlahnode[3] == 5){
        JsonObject NodeID_1 = doc[0];
        int fNodeID_1 = NodeID_1["NodeID"];
        int Suhu = NodeID_1["Suhu"];
        int Kelembapan = NodeID_1["Kelembapan"];
